...
const legacyArticles = [
  // ================= B&M 9호 (최신호) =================
  {
    ...
    clinicalPearls: [
      "알츠하이머병 신약 레카네맙(레캄비)의 실제 임상 도입에 따른 처방 적격 환자 선별 기준, ApoE 검사법, 치료 일정 및 18개월 투여 후 월간 유지 요법 전환 프로토콜을 다룹니다.",
  ...
  },
  {
    ...
    clinicalPearls: [
      "초기 검사 시 아밀로이드 PET 음성이었으나, 추적 관찰 중 인지 능력이 지속적으로 감퇴하며 PET 양성으로 전환되어 마침내 레카네맙 투여를 개시하고 인지 궤적을 보존한 고령 환자 증례입니다.",
  ...
  },
  {
    ...
    clinicalPearls: [
      "아밀로이드-베타 표적 단클론항체인 레카네맙을 12개월간 투여한 결과, 뇌 내 아밀로이드 플라크가 드라마틱하게 완전 제거되어 PET 상 완벽한 음성 전환 및 인지 안정화를 보인 환자의 세부 경과입니다.",
  ...
  },
  {
    ...
    clinicalPearls: [
      "레카네맙 투여 중 신경학적 증상(두통 및 가벼운 시각 왜곡)과 함께 MRI 검사상 ARIA-E(뇌부종) 소견이 확인되어 약물 투여를 일시 보류하고 스테로이드 치료를 통해 가역적으로 회복한 부작용 대처 사례입니다.",
  ...
  },
  {
    ...
    clinicalPearls: [
      "알츠하이머병 치료의 중심축인 아밀로이드 베타 표적 수동면역요법의 원리를 분석하고, 최근 주목받는 아두카누맙, 레카네맙, 도나네맙 및 차세대 트론티네맙의 치료 표적(에피토프)...",
  ...
  },
  {
    ...
    clinicalPearls: [
      "일본의 스마트 에이징 홈, 영국의 치매 친화적 주거 헌장 등 해외 모범 사례를 연구하고 한국형 아파트 및 일반 주택 구조에서 낙상 방지, 배회 위험 최소화를 위해 요구되는 치매 친화적 인테리어 기법...",
  ...
  },
  {
    ...
    clinicalPearls: [
      "개원가에서 빈번히 접하는 경동맥 초음파 증례들을 중심으로 취약성 경동맥 플라크(동맥경화반)를 선별하는 실전 팁을 전수하고, 수치 위주의 스타틴 처방 관행을 넘어 sdLDL-C...",
      "특히 개원가에서의 경동맥 초음파 검사의 해석이야 말로, 이상지질혈 증 관리 및 기타 심/뇌혈관 위험요소의 핵 심이자, 비침습적이자, 개원가 선생님들께 매우 유용한 검사이자, 신경과 의사로서 큰 보람...",
  ...
  },
  {
    ...
    clinicalPearls: [
      "「의학 데이터를 지배하는 AI 기반 시각화 기법」: 의료인의 교양, 생활, 진료 밖 관점을 넓히는 글입니다.",
      "「위스키 인문학 로드」: 의료인의 교양, 생활, 진료 밖 관점을 넓히는 글입니다.",
      "「마약류 약리 기전 총정리 II」: 의료인의 교양, 생활, 진료 밖 관점을 넓히는 글입니다."
    ]
  },
  {
    id: "bm-9-07",
  ...
  // ================= B&M 8호 =================
  {
    ...
    clinicalPearls: [
      "객관적 신경심리 검사에서는 정상 범위이나 환자 스스로 기억력 감퇴를 느끼는 '주관적 인지 저하(SCD)' 상태의 임상적 중요성을 짚고...",
      "Special Topic ‘주관적 인지 저하’, 어떤 증상이 있을 때 병원을 방문해야 하나?",
      "전임상 알츠하이머병이란, 정상 인지 기능을 보이 지만 뇌에 알츠하이머병의 병리 소견(아밀 로이드 단백질, 타우 단백질..."
    ]
  },
  {
    id: "bm-8-02",
    ...
    clinicalPearls: [
      "지속적인 단기 기억력 저하를 호소하는 80세 전직 회계사 남성, 갑작스러운 기억 감퇴로 내원한 73세 여성, 심각한 성격 변화 및 억제 불능 주소의 75세 여성 환자 등 개원가...",
  ...
  },
  {
    ...
    clinicalPearls: [
      "SCD와 MCI 환자들의 삶의 질 변화를 추적한 대규모 유럽 MEMENTO 코호트 분석 결과와, 혈장 neurofilament light chain(NfL) 농도 측정을 통해 뇌 내 신경 변성...",
      "결과 주관적 인지 저하(SCD), 경도 인지장애 (MCI), 알츠하이머병 치매 그룹 간의 혈장 NfL 농도 차이는 유의미한 수준(p＜0.001) 으로 나타났다.",
      "연구 기간 동안 주관적 인지 저하 (SCD) 환자의 30%가 경도 인지장애(MCI) 로, 경도 인지장애(MCI) 환자의 약 30%가 알츠하이머병치매(AD dementia)로 진행 되었으며..."
    ]
  },
  {
    id: "bm-8-04",
    ...
    clinicalPearls: [
      "인지장애 진단 후 유언 대용 신탁 계약을 체결해 자녀 간 거액의 소송이 발생했던 대법원 무효 확정 판결을 토대로, 임상 현장에서 치매 환자...",
      "치매 환자의 경우에는 특 정후견이나 후견계약보다는 성년후견이나 한정후견이 적합할 수 있지만, 치매...",
  ...
  },
  {
    ...
    clinicalPearls: [
      "어지럼증이나 일시적 의식 소실(실신)을 주소로 내원한 신경과 환자들 중, 치명적인 심장 돌연사나 뇌졸중으로 이어질 수 있는 발작성 심방세동, 동정지(sinus arrest), 방실 차단 등 표준 심전도 상...",
  ...
  },
  {
    ...
    clinicalPearls: [
      "「알고 보면 알쏭달쏭한 그린 위 골프 룰 백과」: 의료인의 교양, 생활, 진료 밖 관점을 넓히는 글입니다.",
      "「푸치니 오페라 ‘라 보엠’과 뮤지컬 ‘렌트’」: 의료인의 교양, 생활, 진료 밖 관점을 넓히는 글입니다.",
      "「마약류 약리 기전 총정리 I」: 의료인의 교양, 생활, 진료 밖 관점을 넓히는 글입니다."
    ]
  },
  {
    id: "bm-8-07",
